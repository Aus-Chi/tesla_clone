...
function TeslaAccount({isMenuOpen, setIsMenuOpen, ok}) {
  ...
  return (
    <div className='teslaAccount'>
        ...
        <div className="teslaAccount__car">
            ...
            <Car imgSrc="https://www.tesla.com/tesla_theme/assets/img/mytesla/v3/header-nocar-modelx@2x.jpg?20170815" model="model s" />
        </div>
    </div>
  )
}
